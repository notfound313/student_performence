...
scaler_Curricular_units_2st_sem_approved = joblib.load("model/scaler_Curricular_units_2st_sem_approved.joblib")
scaler_Curricular_units_2st_sem_credited = joblib.load("model/scaler_Curricular_units_2st_sem_credited.joblib")
scaler_Curricular_units_2st_sem_grade = joblib.load("model/scaler_Curricular_units_2st_sem_grade.joblib")
